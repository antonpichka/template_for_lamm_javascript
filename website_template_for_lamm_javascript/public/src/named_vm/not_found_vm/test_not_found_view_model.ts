...
export class TestNotFoundViewModel extends BaseNamedViewModel<DataForNotFoundView,DefaultStreamWState<DataForNotFoundView>> implements INotFoundViewModel {
